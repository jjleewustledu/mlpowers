classdef F18DeoxyGlucoseKinetics < mlkinetics.AbstractKinetics & mlkinetics.F18
    ...
    methods (Static)
        function [this,kmin,k1k3overk2k3] = runPowers(sessDat)
            ...
            this = F18DeoxyGlucoseKinetics( ...
                DTA.loadSessionData(sessDat),...
                TSC.import(sessDat.tsc_fqfn));
            this.v1            = sessDat.v1;
            this.k1            = sessDat.k1;
            this.k2            = sessDat.k2;
            this.k3            = sessDat.k3;
        ...
        function [outputs,studyDat,sessDats] = loopChpc(N)
            assert(isnumeric(N));
            studyDat = mlpowers.StudyDataSingleton.instance; 
        ...
        function this   = simulateMcmc(Ca, fu, k1, k2, k3, k4, t, u0, v1, mapParams)
            ...
            dta_ = struct('times', t, 'becquerels', Ca);
            tsc_ = struct('times', t, 'becquerels', qpet);
	...
	methods
 		function this = F18DeoxyGlucoseKinetics(varargin)
            ...
            this.dependentData    = {this.tsc.becquerels};
        ...
        function this = simulateItsMcmc(this)
            this = mlpowers.F18DeoxyGlucoseKinetics.simulateMcmc( ...
                   this.dtaNyquist.becquerels, this.fu, this.k1, this.k2, this.k3, this.k4, this.dtaNyquist.times, this.u0, this.v1, this.mapParams);
        end
        ...
        function q2   = itsQ2(this)
            q2 = mlpowers.F18DeoxyGlucoseKinetics.q2( ...
                this.dtaNyquist.becquerels, this.k1, this.itsA, this.itsB, this.k4, this.tscNyquist.times);
        end
        function q3   = itsQ3(this)
            q3 = mlpowers.F18DeoxyGlucoseKinetics.q3( ...
                this.dtaNyquist.becquerels, this.k1, this.itsA, this.itsB, this.k3, this.tscNyquist.times);
        end
        function qpet = itsQpet(this)
            import mlpowers.*;            
            tNyquist = this.tscNyquist.times;
            qNyquist = F18DeoxyGlucoseKinetics.qpet( ...
                this.dtaNyquist.becquerels, this.fu, this.k1, this.k2, this.k3, this.k4, tNyquist, this.v1);
        ...
        function ed   = estimateDataFast(this, fu, k1, k2, k3, k4, u0, v1)
            ...
            tNyquist = this.tscNyquist.times;
            qNyquist = F18DeoxyGlucoseKinetics.qpet( ...
                this.dtaNyquist.becquerels, fu, k1, k2, k3, k4, tNyquist, v1);
        ...
        function plot(this, varargin)
            figure;
            max_dta   = max(this.dta.becquerels);
            max_data1 = max([max(this.tsc.becquerels) max(this.itsQpet)]);
            plot(this.dta.times, this.dta.becquerels/max_dta, ':o',  ...
    ...
    methods (Access = 'private')
        function plotParArgs(this, par, args, vars)
            ...
            figure
            hold on
            plot(this.dta.times, this.dta.becquerels, ':o', ...
                 this.tsc.times, this.tsc.becquerels, ':s');
            for v = 1:length(args)
                argsv = args{v};
                qpet  = mlpowers.F18DeoxyGlucoseKinetics.qpet( ...
                    this.dtaNyquist.becquerels, argsv{1}, argsv{2}, argsv{3}, argsv{4}, this.tscNyquist.times, argsv{6});
